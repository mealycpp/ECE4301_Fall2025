...
//Date        : Mon Dec  8 05:01:18 2025
//Host        : ckpai running 64-bit Ubuntu 24.04.3 LTS
//Command     : generate_target poseidon_block.bd
//Design      : poseidon_block
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "poseidon_block,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=poseidon_block,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=13,da_board_cnt=2,da_bram_cntlr_cnt=2,da_ps7_cnt=2,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "poseidon_block.hwdef" *) 
module poseidon_block
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > poseidon_block axi_bram_ctrl_0_bram" *) 
  (* KEEP_HIERARCHY = "YES" *) 
  poseidon_block_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  poseidon_block_axi_bram_ctrl_0_bram_0 axi_bram_ctrl_0_bram
  ...
  poseidon_block_axi_gpio_0_1 leds
  ...
  poseidon_block_poseidon_accel_axi_l_0_2 poseidon_accel_axi_l_0
       (.s_axi_aclk(processing_system7_0_FCLK_CLK0),
  ...
  (* BMM_INFO_PROCESSOR = "arm > poseidon_block axi_bram_ctrl_0" *) 
  (* KEEP_HIERARCHY = "YES" *) 
  poseidon_block_processing_system7_0_1 processing_system7
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  poseidon_block_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  poseidon_block_smartconnect_0_1 smartconnect_0
  ...
  poseidon_block_leds_0 switches
