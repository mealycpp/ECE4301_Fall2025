...
#
# Script generated by Vivado on Sun Dec 07 17:51:58 PST 2025
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : poseidon_block_wrapper.sh
...
#
# Usage        : poseidon_block_wrapper.sh
#                poseidon_block_wrapper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                poseidon_block_wrapper.sh [-rerun]
#                poseidon_block_wrapper.sh [-reset_run]
#                poseidon_block_wrapper.sh [-clean]
#                poseidon_block_wrapper.sh [-reset_log]
#                poseidon_block_wrapper.sh [-help]
#
...
#                script (type 'poseidon_block_wrapper.sh -help' for more information).
#
...
design_libs=(xilinx_vip xpm xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_22 processing_system7_vip_v1_0_24 proc_sys_reset_v5_0_17 smartconnect_v1_0 axi_register_slice_v2_1_36 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_5 axi_gpio_v2_0_37 axi_bram_ctrl_v4_1_13 blk_mem_gen_v8_4_12)

# simulation root library directory
sim_lib_dir="vcs_lib"

# script info
echo -e "poseidon_block_wrapper.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./poseidon_block_wrapper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/ec67/hdl" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/9a25/hdl" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/f0b6/hdl/verilog" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/00fe/hdl/verilog" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/ec67/hdl" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/9a25/hdl" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/f0b6/hdl/verilog" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/00fe/hdl/verilog" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
  "../../../../../../Group\\ A/Final_Project/poseidon_bench/poseidon_bench.srcs/sources_1/new/poseidon_stub.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/ec67/hdl" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/9a25/hdl" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/f0b6/hdl/verilog" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/00fe/hdl/verilog" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
  "../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_22 $vlogan_opts -sverilog +incdir+"../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/ec67/hdl" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/9a25/hdl" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/f0b6/hdl/verilog" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/00fe/hdl/verilog" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
  "../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/b16a/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_24 $vlogan_opts -sverilog +incdir+"../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/ec67/hdl" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/9a25/hdl" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/f0b6/hdl/verilog" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/00fe/hdl/verilog" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/ec67/hdl" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/9a25/hdl" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/f0b6/hdl/verilog" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/00fe/hdl/verilog" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_register_slice_v2_1_36 $vlogan_opts +v2k +incdir+"../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/ec67/hdl" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/9a25/hdl" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/f0b6/hdl/verilog" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/00fe/hdl/verilog" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_12 $vlogan_opts +v2k +incdir+"../../../../../../../../../opt/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/ec67/hdl" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/9a25/hdl" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/f0b6/hdl/verilog" +incdir+"../../../poseidon_bench.gen/sources_1/bd/poseidon_block/ipshared/00fe/hdl/verilog" +incdir+"/opt/Xilinx/2025.2/data/xilinx_vip/include" \
  ...
  "../../../../../../Group\\ A/Final_Project/poseidon_bench/poseidon_bench.gen/sources_1/bd/poseidon_block/hdl/poseidon_block_wrapper.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.poseidon_block_wrapper xil_defaultlib.glbl -o poseidon_block_wrapper_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./poseidon_block_wrapper_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ckpai/ece4301/Group"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key poseidon_block_wrapper_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc poseidon_block_wrapper_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./poseidon_block_wrapper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: poseidon_block_wrapper.sh [-help]\n\
Usage: poseidon_block_wrapper.sh [-step]\n\
Usage: poseidon_block_wrapper.sh [-lib_map_path]\n\
Usage: poseidon_block_wrapper.sh [-rerun]\n\
Usage: poseidon_block_wrapper.sh [-reset_run]\n\
Usage: poseidon_block_wrapper.sh [-clean]\n\
Usage: poseidon_block_wrapper.sh [-reset_log]\n\
Usage: poseidon_block_wrapper.sh [-keep_index]\n\
Usage: poseidon_block_wrapper.sh [-noclean_files]\n\n\
