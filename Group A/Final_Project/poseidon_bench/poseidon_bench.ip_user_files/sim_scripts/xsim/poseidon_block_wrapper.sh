...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L xpm -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L processing_system7_vip_v1_0_24 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_36 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_37 -L axi_bram_ctrl_v4_1_13 -L blk_mem_gen_v8_4_12 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot poseidon_block_wrapper xil_defaultlib.poseidon_block_wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim poseidon_block_wrapper -key {Behavioral:sim_1:Functional:poseidon_block_wrapper} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_8597.protoinst" -protoinst "protoinst_files/poseidon_block.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_22 processing_system7_vip_v1_0_24 proc_sys_reset_v5_0_17 smartconnect_v1_0 axi_register_slice_v2_1_36 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_5 axi_gpio_v2_0_37 axi_bram_ctrl_v4_1_13 blk_mem_gen_v8_4_12)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb poseidon_block_wrapper.wdb xsim.dir libdpi.so)
